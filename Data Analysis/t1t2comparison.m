...
% Comparisons
subplot(3, 3, 2);
showIm(abs(t1{1, 1} - t1{2, 1}), ['Abs(', t1{1, 2}, ' - ', t1{2, 2}, ')']);
subplot(3, 3, 4);
showIm(abs(t1{1, 1} - t2{2, 1}), ['Abs(', t1{1, 2}, ' - ', t2{2, 2}, ')']);
subplot(3, 3, 6);
showIm(abs(t2{1, 1} - t1{2, 1}), ['Abs(', t2{1, 2}, ' - ', t1{2, 2}, ')']);
subplot(3, 3, 8);
showIm(abs(t2{1, 1} - t2{2, 1}), ['Abs(', t2{1, 2}, ' - ', t2{2, 2}, ')']);
